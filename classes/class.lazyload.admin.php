...
class TDT_Lazyload_Admin{
	...
	function __construct(){
		...
		$this->tdt_lazyload_options = [
			...
			'tdt_lazyload_enable_for_advanced' => [
				...
				'video'  => 'Video <code>&lt;video...&gt;&lt;/video&gt;</code>',
			],
		];
	...
	private function install(){
		...
		add_option(
			'tdt_lazyload_exclude_video_with_class',
			'nolazyload,'
		);
	}
            ...
            <div class="row">
                ...
                <div class="col-md-offset-1 col-md-3 donate">
                    ...
                    <ul style="list-style-type: square">
                        <li>
                            <a href="https://wordpress.org/plugins/tdt-lazyload/" target="_blank">TDT Lazyload on WordPress.org</a>
                        </li>
                        <li>
                            <a href="https://github.com/tdtgit/tdt-lazyload" target="_blank">TDT Lazyload on Github</a>
                        </li>
                        <li>
                            <a href="https://duonganhtuan.com" target="_blank">My personal website</a>
                        </li>
                    </ul>
                    <h2>Donate</h2>
                    ...
                    <p>
                        <a href="https://paypal.me/mrsugarvn/2" target="_blank" title="Donate using Paypal"><img height="128" src="<?php echo TDT_LAZYLOAD_PLUGIN_DIR; ?>/assets/img/donate.png" alt="Donate me"></a>
                    </p>
                </div>
            </div>
        </div>
	...
	public function init(){
		...
		add_settings_field(
			...
			'Disable plugin?',
			[$this, 'render_tdt_lazyload_enable'],
			'tdt-lazyload',
			'tdt-lazyload-general-section'
		);
		...
		add_settings_field(
			...
			[$this, 'render_tdt_lazyload_display_on'],
			'tdt-lazyload',
			'tdt-lazyload-general-section'
		);
		...
		add_settings_field(
			'tdt_lazyload_enable_for',
			'Enable lazyload image on:',
			[$this, 'render_tdt_lazyload_enable_for'],
			'tdt-lazyload',
			'tdt-lazyload-general-section'
		);
		...
		add_settings_field(
			'tdt_lazyload_enable_for_advanced',
			'Enable lazyload for:',
			[$this, 'render_tdt_lazyload_enable_for_advanced'],
			'tdt-lazyload',
			'tdt-lazyload-advanced-section'
		);
		...
		add_settings_field(
			...
			[$this, 'render_tdt_lazyload_exclude_image_with_class'],
			'tdt-lazyload',
			'tdt-lazyload-advanced-section'
		);
		...
		add_settings_field(
			...
			[$this, 'render_tdt_lazyload_exclude_iframe_with_class'],
			'tdt-lazyload',
			'tdt-lazyload-advanced-section'
		);
		...
		add_settings_field(
			'tdt_lazyload_exclude_video_with_class',
			'Exclude video from lazyload:',
			[$this, 'render_tdt_lazyload_exclude_video_with_class'],
			'tdt-lazyload',
			'tdt-lazyload-advanced-section'
		);
	...
	public function render_tdt_lazyload_enable(){
		echo '<input type="checkbox" name="tdt_lazyload_disable" value="1" ' . checked(1,
				get_option('tdt_lazyload_disable'), FALSE) . ' />';
	}
	...
	public function render_tdt_lazyload_exclude_image_with_class(){
      ...
      <p>A comma-separated list of CSS class of images (<code>&lt;img&gt;</code>) you want to exclude from being optimized.</p>';
	}
	...
	public function render_tdt_lazyload_exclude_iframe_with_class(){
      ...
      <p>A comma-separated list of CSS class of iframes (<code>&lt;iframe&gt;</code>) you want to exclude from being optimized.</p>';
	}

	public function render_tdt_lazyload_exclude_video_with_class(){
		echo '<input type="text" style="width: 100%" name="tdt_lazyload_exclude_video_with_class" value="' . get_option('tdt_lazyload_exclude_video_with_class') . '" />
      <p>A comma-separated list of CSS class of videos (<code>&lt;video&gt;</code>) you want to exclude from being optimized.</p>';
	}
}

if (is_admin()){
	$lazyload_admin = new TDT_Lazyload_Admin();
	register_activation_hook(__FILE__, [$lazyload_admin, 'install']);
}
